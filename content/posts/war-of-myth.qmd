...
These are not two separate frameworks in dialogue. The tetrad is a grammar of media effects. The four sources are that grammar's conjugation in the domain of collective transformation. They describe the same underlying dynamics: what gets amplified, what gets displaced, what gets recovered, and what happens when the process exceeds its own limits. The argument in this article is enacting this structure even as you parse the meaning of these words. Naming it makes the practical consequences legible for those who build in these technologies.

The same duality deserves naming at the level of effects rather than operations. Enhancement and fragmentation are not opposing outcomes between which a designer chooses. They are one mechanism viewed from inside and outside. The immersive medium's power to retrieve embodied, communal knowing is precisely its power to privatize perception: each participant inhabits a designed mode of experience, a world engineered for one, and the aggregate of millions of incompatible singularities is itself a new form of the fragmentation the medium claims to heal. Print's precedent is instructive: it homogenized (typographic consciousness presented itself as universal) even as it fragmented, rendering other epistemologies illegible. The tension lives in the mediation structure, not the cognition; any builder who believes the medium's retrieval function automatically repairs its fragmentation function has mistaken the grammar for a guarantee. This is the "We share a device, not a world" problem examined at length in a companion piece, ["Information Architecture in the [Augmented|Virtual|eXtended] Reality Age"](/content/posts/info-arch-in-avxr).
